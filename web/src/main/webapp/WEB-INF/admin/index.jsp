    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="#" onclick="showMenuDashBord(this)" data ='{"url":"dashbord/init","id":"1000"}' >
                        <i class="fa fa fa-bar-chart-o"></i> <span class="nav-label">首页</span>
                    </a>
                </li>

                <%--<li>--%>
                    <%--<a href="javascript:void(0)" onclick="showMenuSite(this)" data ='{"url":"achieve/init","id":"2101"}'><i class="fa fa fa-bar-chart-o"></i> <span class="nav-label">首页</span></a>--%>
                <%--</li>--%>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="javascript:void(0)" onclick="showMenuSite(this,'son')" data ='{"url":"relationshipAdmin/init","id":"3102"}'>演示页面</a></li>
                        <%--<li><a href="javascript:void(0)" onclick="showMenuSite(this,'son')" data ='{"url":"rateAdmin/init","id":"3103"}' >首页权重配置</a></li>--%>
                    </ul>
                </li>
                    ...
                    <div class="tab-content" id="tabContent">
                        <div id="1000" class="tab-pane active">
                            <div class="panel-body  my-panel-body" >
                                <div class="iframe" >
                                    <iframe src="./dashbord/init"  name="iframepage" frameBorder=0  width="100%" height="0"  onload="reinitIframeOnload(this);" ></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
