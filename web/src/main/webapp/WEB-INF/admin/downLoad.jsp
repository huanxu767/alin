    ...
    <div class="wrapper my-wrapper " >
        ...
        <div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ibox" id="newSquareBox">
                        <div class="ibox-title">
                            <h5>首购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary" id="NEW_LOAN_ALL_CUST">人数-</span>
                            <span class="label label-primary" id="NEW_LOAN_ALL_UP">增长-</span>
                            <span class="label label-primary" id="NEW_LOAN_ALL">贡献度(万元)-</span>
                            <span class="label label-primary" id="NEW_GXD_UP">增长-</span>
                            <span class="label label-primary" id="NEW_GXD">贡献率-</span>
                        </div>
                        <div class="ibox-content">
                            <div class="sk-spinner sk-spinner-wave">
                                <div class="sk-rect1"></div>
                ...
                <div class="col-lg-6">
                    <div class="ibox" id="oldSquareBox">
                        <div class="ibox-title">
                            <h5>复购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary" id="OLD_LOAN_ALL_CUST">人数-</span>
                            <span class="label label-primary" id="OLD_LOAN_ALL_UP">增长-</span>
                            <span class="label label-primary" id="OLD_LOAN_ALL">贡献度(万元)-</span>
                            <span class="label label-primary" id="OLD_GXD_UP">增长-</span>
                            <span class="label label-primary" id="OLD_GXD">贡献率-</span>
                        </div>
                        <div class="ibox-content">
                            <div class="sk-spinner sk-spinner-wave">
                                <div class="sk-rect1"></div>
            ...
            <div class="ibox" id="custApplyBox" >
                ...
                <div class="ibox-content">
                    ...
                    <div class="product-container" style="height: 680px;margin-bottom: 20px;">
                        ...
                        <div class="my-box ktcg-khs-position" >
                            ...
                            <div class="my-box-content width-50">
                                ...
                                <div><p>存量客户(万)</p><p id="CN_HAVE_CUST_SUCOPN">-</p></div>
                            </div>
                            <div class="my-box-content width-50">
                                <div ><p>增长</p><p id="CN_KTCG_ZZ">-</p></div>
                                <div><p>开通率</p><p id="CN_KTCG_KTL">-</p></div>
                            </div>
                        </div>
                        <!--第四层-->
                        <div class="my-box sqkt-khs-position" >
                            ...
                            <div class="my-box-content width-50">
                                <div><p>查询期客户(万)</p><p id="CN_CUST_OPEN">-</p></div>
                                <div ><p>增长</p><p id="CN_SQKT_ZZ">-</p></div>
                            </div>
                            <div class="my-box-content ">
                                <div class="cunliang" >
                                    <span>存量客户(万)</span><span id="CN_HAVE_CUST_OPEN">-</span>
                                </div>
                            </div>
                        ...
                        <div class="my-box zdkt-khs-position" >
                            ...
                            <div class="my-box-content width-50">
                                <div><p>查询期客户</p><p id="CN_CUST_AUTOPN">-</p></div>
                                <div ><p>增长</p><p id="CN_ZDKT_ZZ">-</p></div>
                            </div>
                            <div class="my-box-content ">
                                <div class="cunliang" >
                                    <span>存量客户(万)</span><span id="CN_HAVE_CUST_AUTOPN">-</span>
                                </div>
                            </div>
                        </div>
                        <!--第五层-->
                        <div class="my-box ysxyh-khs-position" >
                            ...
                            <div class="my-box-content width-100">
                                <div ><p>存量客户(万)</p><p id="CN_CUST_PRECRD">-</p></div>
                            </div>
                        </div>
                        <div class="my-box sqcg-khs-position" >
                            ...
                            <div class="my-box-content width-50">
                                ...
                                <div><p>存量客户(万)</p><p id="CN_HAVE_CUST_SUCAPY">-</p></div>
                            </div>
                            <div class="my-box-content width-50">
                                <div ><p>增长</p><p id="CN_SQCG_ZZ">-</p></div>
                                <div><p>申请通过率</p><p id="CN_SQ_KTL">-</p></div>
                            </div>
                        </div>
                        <!--第六层-->
                        <div class="my-box sqyh-khs-position" >
                            ...
                            <div class="my-box-content ">
                                <div class="cunliang" >
                                    <span>存量客户(万)</span><span id="CN_HAVE_CUST_APPLY">-</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <p class="text-primary">指标说明【存量用户定义为开业到查询期前的用户】</p>
                        <ul>
                            <li> 申请额度用户：主动申请额度用户</li>
                            <li>申请额度成功客户：主动申请额度中通过的客户</li>
                            <li> 预授信客户：截止到查询期结束所有的定向邀请用户</li>
                            <li> 申请开通客户：申请开通的客户，包含预授信客户激活额度申请和主动申请客户绑定</li>
                            <li> 开通成功客户：查询期内成功开通的客户</li>
                            <li>首购客户人数：查询期内首次使用任性付的客户</li>
                            <li> 复购用户人数：包含最早贷款时间在查询期之前的客户以及在查询期内有两次及以上贷款的首购用户</li>
        ...
        <div>
            ...
            <div class="ibox" id="plkdrsBox">
                <div class="ibox-title">
                    <h5>构成分析&nbsp;&nbsp;</h5>
                    <span class="label label-primary">品类客单人数</span>
                </div>
                <div class="ibox-content">
                    <div class="sk-spinner sk-spinner-wave">
                        <div class="sk-rect1"></div>
            ...
            <div class="row">
                <div class="col-lg-6" >
                    <div class="ibox" id="easySgkhBox">
                        <div class="ibox-title">
                            <h5>首购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary" id="ebFirstBuy">-</span>
                            <span class="label label-primary" >增长<span id="ebFirstBuyUp">-</span></span>
                ...
                <div class="col-lg-6" >
                    <div class="ibox" id="easyFgBox">
                        <div class="ibox-title">
                            <h5>复购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary" id="ebAgainBuy">-</span>
                            <span class="label label-primary" >增长<span id="ebAgainBuyUp">-</span></span>
                            <div class="ibox-tools">
                                <%--<a href="javascript:void(0);" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal6">?</a>--%>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6" >
                    <div class="ibox" id="onlineSgbox">
                        <div class="ibox-title">
                            <h5>首购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary"><span id="onlineFirstBuy">-</span></span>
                            <span class="label label-primary">增长<span id="onlineFirstBuyUp">-</span></span>
                            <div class="ibox-tools">
                                <%--<a href="javascript:void(0);" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal6">?</a>--%>
                            </div>
                        </div>
                ...
                <div class="col-lg-6" >
                    <div class="ibox" id="onlineFgBox">
                        <div class="ibox-title">
                            <h5>复购客户&nbsp;&nbsp;</h5>
                            <span class="label label-primary"><span id="onlineAgainBuy">-</span></span>
                            <span class="label label-primary">增长<span id="onlineAgainBuyUp">-</span></span>
                            <div class="ibox-tools">
                                <%--<a href="javascript:void(0);" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal6">?</a>--%>
                            </div>
                        </div>
...
<script>
    ...
    function initDesc(){
        ...
        $("#muluDesc").html("【达成率："+year+"年"+quarterDesc+"季度】");
