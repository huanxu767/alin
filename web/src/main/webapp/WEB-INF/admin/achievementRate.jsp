        ...
        <div class="ibox-content">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <label class="col-md-1 control-label">季度筛选</label>
                    <div class="col-md-2">
                        <select class="form-control m-b"  id="quarter" onchange="changeQuarter(this)">
                            ...
                            <option value="2"  <c:if test="${quarter eq 2}">selected="selected"</c:if>>一、二季度</option>
                            <option value="3"  <c:if test="${quarter eq 3}">selected="selected"</c:if>>一、二、三季度</option>
                            <option value="4"  <c:if test="${quarter eq 4}">selected="selected"</c:if>>一、二、三、四季度</option>
                        </select>
                    </div>
